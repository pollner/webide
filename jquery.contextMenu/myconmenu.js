	...
	function deletion(p){
		...
		if(con){
			$.ajax({
				type: "POST",
		   		url: "index.php",
		   		data: "com=Profiler&del="+urlencode(p),
		...
		//parent.Daten.location.href=s;
           	$.ajax({
                    ...
                    url: "index.php",
                       //data: "fid=&mode=WRITE&content="+encodeURIComponent(content),
                    //data: "fid="+encodeURIComponent(s)+"&mode=READ",
                    data: "com=Profiler&zip="+urlencode(s),
		...
		//parent.Daten.location.href=s;
           	$.ajax({
                    ...
                    url: "index.php",
                       //data: "fid=&mode=WRITE&content="+encodeURIComponent(content),
                    //data: "fid="+encodeURIComponent(s)+"&mode=READ",
                    data: "com=Profiler&unzip="+urlencode(s),
                    success: function(zipmessage){                   
                           //if(answer=="Not Found") alert("Unreachable");
                           //else parent.Daten.location.href=answer;
	                       messenger(zipmessage);
		...
		$(document).ready( function() {
				...
				function(action, el, pos) {
					...
					switch(action){
						...
						case 'Explorer': 
						//alert($(el).attr('rel'));
						//parent.Daten.location.href='?com=Explorer&dir='+urlencode($(el).attr('rel'));break;
						parent.Daten.location.href='?com=Explorer&dir='+$(el).attr('href');break;
						...
						//case 'Test': parent.Daten.location.href='?com=Test&path='+$(el).attr('href');break;	
 ...
 //ZIP				
				...
				$(".zip").contextMenu({
					...
					switch(action){
						...
						case 'edit': parent.Daten.location.href='?com=EditArea&dir='+$(el).attr('href');break;
						...
						case 'ziplist'  : ziplist($(el).attr('href')); break;
						case 'rename': renaming(id=$(el).attr('id'),href=$(el).attr('rel'));break;
